...
export default function WebHostingHero() {
  ...
  const titleText = "High Performance Website Hosting"
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      >
        <iframe 
          src="https://my.spline.design/datacenterrack-9f8e2c5d2f4a4b8f8c8d8e8f8f8f8f8f/" 
          frameBorder="0" 
          width="100%" 
          height="100%"
      ...
      <div className="relative z-30 text-center px-4 lg:px-8 max-w-6xl mx-auto">
        ...
        >
          ...
          <span className="font-orbitron font-semibold text-lg text-glow">99.9% Uptime Guarantee</span>
        </motion.div>
        ...
        >
          Instant setup, ultra-fast SSD NVMe storage, unlimited bandwidth. 
          Professional hosting solutions powered by cutting-edge technology.
        </p>
