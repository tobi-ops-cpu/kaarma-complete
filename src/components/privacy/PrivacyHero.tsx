  ...
  return (
    <section ref={sectionRef} className="relative py-20 lg:py-32 overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute bottom-32 right-16 w-32 h-32 bg-gradient-to-br from-purple-500/15 to-blue-500/15 rounded-full blur-2xl"
      />
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="w-20 h-20 bg-gradient-to-br from-blue-500 to-purple-500 rounded-3xl flex items-center justify-center mx-auto mb-8 glow-blue"
          >
            <Lock size={40} className="text-white" weight="bold" />
          </motion.div>
          ...
          >
            {splitText("Privacy & Data Protection")}
          </motion.h1>
          ...
          >
            Your privacy is fundamental to our values. Learn how we collect, protect, and use your data with complete transparency.
          </motion.p>
          ...
          >
            <div className="w-3 h-3 bg-blue-400 rounded-full animate-pulse-glow" />
            <span className="font-semibold text-blue-400">GDPR & CCPA Compliant</span>
          </motion.div>
        </motion.div>
      </div>
    </section>
