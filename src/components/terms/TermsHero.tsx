  ...
  return (
    <section ref={sectionRef} className="relative py-20 lg:py-32 overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-20 left-10 w-20 h-20 bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-full blur-xl"
      />
      <motion.div
        animate={{
          y: [0, 15, 0],
        ...
        className="absolute bottom-32 right-16 w-32 h-32 bg-gradient-to-br from-red-500/15 to-orange-500/15 rounded-full blur-2xl"
      />
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="w-20 h-20 bg-gradient-to-br from-orange-500 to-red-500 rounded-3xl flex items-center justify-center mx-auto mb-8 glow-orange"
          >
            <ShieldCheck size={40} className="text-white" weight="bold" />
          </motion.div>
          ...
          >
            <div className="w-3 h-3 bg-orange-400 rounded-full animate-pulse-glow" />
            <span className="font-semibold text-orange-400">Last Updated: January 2024</span>
          </motion.div>
        </motion.div>
      </div>
    </section>
