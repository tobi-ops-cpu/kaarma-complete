...
export default function MinecraftFAQSection() {
  ...
  const faqs = [
    {
      question: "Which Minecraft versions do you support?",
      answer: "We support all Minecraft Java Edition versions from 1.7.10 onwards, including the latest releases. Our servers are optimized for both legacy and modern versions, ensuring compatibility with your favorite mods and plugins."
    },
    {
      question: "Can I install mods and plugins?",
      answer: "Absolutely! Our plans include full mod and plugin support. You can easily install mods through our one-click installer or upload your own. We support Forge, Fabric, Bukkit, Spigot, Paper, and many other popular mod loaders."
    },
    {
      question: "How much RAM do I need for my Minecraft server?",
      answer: "The RAM requirement depends on your mods, plugins, and player count. Use our premium RAM calculator to determine the optimal amount. Generally, 2GB is sufficient for vanilla servers with up to 10 players, while heavily modded servers may require 8GB or more."
    },
    {
      question: "Do you provide DDoS protection for Minecraft servers?",
      answer: "Yes, all our Minecraft hosting plans include enterprise-grade DDoS protection specifically designed for gaming servers. Our network can handle attacks up to 100Gbps, ensuring your server stays online during peak gameplay."
    },
    {
      question: "Can I upgrade my plan as my server grows?",
      answer: "Absolutely! You can upgrade your plan at any time without downtime. Our scalable infrastructure allows seamless transitions between plans as your player base grows or you add more mods and plugins."
    },
    {
      question: "What control panel do you use?",
      answer: "We use a custom-enhanced version of Pterodactyl, specifically optimized for Minecraft hosting. Our panel includes features like one-click mod installation, automated backups, file management, and real-time performance monitoring."
    },
    {
      question: "Do you offer automated backups?",
      answer: "Yes, all our plans include automated hourly backups with 30-day retention. You can easily restore your world to any previous state with just a few clicks from your control panel."
    },
    {
      question: "What support do you provide for Minecraft servers?",
      answer: "We offer 24/7 Minecraft-specific support through multiple channels including live chat, support tickets, and our Discord community. Our team includes experienced Minecraft server administrators who can help with mod conflicts, performance optimization, and more."
    }
  ]
        ...
        >
          <div className="p-8 rounded-2xl max-w-2xl mx-auto shadow-lg border transition-all duration-300"
            ...
            <p className="mb-6 leading-relaxed text-gray-300">
              Our Minecraft hosting experts are available 24/7 to help you with any questions or issues you might have.
            </p>
